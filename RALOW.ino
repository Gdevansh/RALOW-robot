...
/*  If we are taking output(printing something) in serial monitor then we can use Rx pin..... not Tx pin 
  and vice versa. At the time of code uploading remove connections of Rx and Tx pin.
  A0 is only for analog input */
